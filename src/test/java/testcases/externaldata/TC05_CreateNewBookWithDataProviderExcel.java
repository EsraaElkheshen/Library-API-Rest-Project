...
import static utility.Utilities.getBookData;


public class TC05_CreateNewBookWithDataProviderExcel extends TestBase {


    @Test(priority = 1, description ="createNewBookWithDataProviderExcel", dataProvider = "bookData")
    public void createNewBookWithDataProviderExcel(Map<String, String> requestData) {
